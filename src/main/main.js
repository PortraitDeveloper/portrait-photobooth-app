...
function createCheckingWindow() {
  checkingWindow = new BrowserWindow({
    width: 350,
    height: 200,
    resizable: false, // Prevent resizing
    parent: mainWindow,
  ...
  checkingWindow.loadFile("./src/renderer/pages/checking-network.html");
  checkingWindow.setMenu(null); // Remove menu bar
